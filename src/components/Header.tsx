...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // If on homepage, the hero section is 600vh tall (the SteelScroll component)
      // We want it transparent until we scroll past it.
            ...
            {mobileMenuOpen && (
              ...
              >
                <div className="flex flex-col items-center gap-8 w-full max-w-sm mt-12">
                  ...
                  {/* Ensure mobile menu uses standard dark color since mobile menu bg is yellow */}
                  <motion.button
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
